...
#define	USART_TX_RX_mode		((uint32_t)(1<<2 | 1<<3))
...
//10: 2 Stop bits
//11: 1.5 Stop bit
#define UART_StOP_1BIT			(uint32_t)(0b00<<12)
#define UART_Stop_HALF_BIT		(uint32_t)(0b01<<12)
#define UART_Stop_2BIT			(uint32_t)(0b10<<12)
#define UART_Stop_1_HALF_BIT	(uint32_t)(0b11<<12)
