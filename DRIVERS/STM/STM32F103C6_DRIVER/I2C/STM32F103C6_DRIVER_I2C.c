...
void MCAL_I2C_INIT(I2C_typeDef* I2Cx , I2C_Config* I2C_cfg)
{
	uint16_t tmpreg = 0, freqrange = 0;
		...
		if (I2C_cfg->I2C_Mode == I2C_mode_I2C)
		{
			...
			if ((I2C_cfg->I2C_ClockSpeed == I2C_SCLK_SM_50K)||(I2C_cfg->I2C_ClockSpeed == I2C_SCLK_SM_100K) )
			{
				...
				result = (uint16_t)(pclk1 / ( I2C_cfg->I2C_ClockSpeed << 1   )   );
			...
			tmpreg |= (uint16_t)(I2C_cfg->I2C_ACK_Control | I2C_cfg->General_Call_Address_Detection | I2C_cfg->I2C_Mode |  I2C_cfg->StretchMode );
			...
			tmpreg = 0 ;
			if (I2C_cfg->I2C_Slave_Address.Enable_Dual_ADD == 1)
			{
			...
			tmpreg  |= I2C_cfg->I2C_Slave_Address.I2C_Addressing_Slave_mode ;
			I2Cx->OAR1 = tmpreg;
...
{
	//todo : support timeout (configure timer working for specic duration rise interrupt
...
uint8_t MCAL_I2C_SLAVE_RECIEVEDATA(I2C_typeDef* I2Cx)
{
